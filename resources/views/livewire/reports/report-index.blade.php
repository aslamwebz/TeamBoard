<div class="space-y-6">
    ...
    <flux:modal name="delete-report" wire:model="showDeleteModal">
        <div class="space-y-6">
            <div>
                <flux:heading size="lg">Delete Report</flux:heading>
                <flux:text class="mt-2">Are you sure you want to delete this report? This action cannot be undone.</flux:text>
            </div>
