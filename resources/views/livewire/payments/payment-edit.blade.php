<div>
    <div class="sm:flex sm:items-center">
        <div class="sm:flex-auto">
            <h1 class="text-base font-semibold leading-6 text-gray-900">Edit Payment</h1>
            <p class="mt-2 text-sm text-gray-700">Update the payment information.</p>
        </div>
    </div>
        ...
        <div class="bg-white px-4 py-8 shadow sm:rounded-lg sm:px-10">
            <form class="space-y-6" wire:submit="update">
                ...
                <div class="flex justify-end space-x-3">
                    <a href="{{ route('payments.show', $payment) }}" class="rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50">Cancel</a>
