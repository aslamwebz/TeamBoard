<div class="max-w-3xl mx-auto p-6">
    <div class="flex items-center justify-between mb-6">
        <h1 class="text-2xl font-bold text-foreground">Edit Phase: {{ $phase->name }}</h1>
    ...
    <div class="bg-white dark:bg-zinc-800 rounded-lg border border-zinc-200 dark:border-zinc-700 p-6">
        <form wire:submit="updatePhase" class="space-y-6">
            ...
            <div class="flex justify-between">
                <flux:button variant="danger" type="button" wire:click="deletePhase" onclick="confirm('Are you sure you want to delete this phase?') || event.stopImmediatePropagation()">
                    Delete Phase
                </flux:button>
