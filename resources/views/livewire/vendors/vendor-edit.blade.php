<div>
    <div class="mb-6">
        ...
        <p class="text-gray-600">Update details for {{ $vendor->name }}</p>
    </div>
    ...
    <div class="bg-white shadow overflow-hidden sm:rounded-lg">
        <form wire:submit="update" class="p-6">
            ...
            <div class="mt-6 flex justify-end space-x-3">
                <a href="{{ route('vendors.show', $vendor->id) }}" class="inline-flex items-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                    Cancel
                </a>
                <button 
                    type="submit" 
