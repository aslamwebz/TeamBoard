<div>
    <div class="max-w-2xl mx-auto">
        <div class="mb-6">
            <h1 class="text-2xl font-bold text-foreground">Edit Team</h1>
            <p class="text-muted-foreground">Update team information and settings.</p>
        </div>

        <div class="bg-white dark:bg-zinc-800 rounded-lg border border-zinc-200 dark:border-zinc-700">
            <form wire:submit="updateTeam" class="p-6">
                <div class="space-y-6">
                    <!-- Team Name -->
                    <div>
